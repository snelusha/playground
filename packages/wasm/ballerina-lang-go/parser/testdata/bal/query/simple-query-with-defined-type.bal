...
function getRecordValue((record {|PersonK value;|}|error?)|(record {|PersonK value;|}?) returnedVal) returns PersonK? {
...
function testSimpleSelectQueryWithSimpleVariable() returns PersonK[] {

    PersonK p1 = {firstName: "Alex", lastName: "George", age: 23};
    PersonK p2 = {firstName: "Ranjan", lastName: "Fonseka", age: 30};
    PersonK p3 = {firstName: "John", lastName: "David", age: 33};

    PersonK[] personList = [p1, p2, p3];
...
function testSimpleSelectQueryWithRecordVariable() returns PersonK[] {
...
function testSimpleSelectQueryWithRecordVariableV2() returns PersonK[] {
...
function testSimpleSelectQueryWithWhereClause() returns PersonK[] {
...
function testFilteringNullElements() returns PersonK[] {

    PersonK p1 = {firstName: "Alex", lastName: "George", age: 23};
    PersonK p2 = {firstName: "Ranjan", lastName: "Fonseka", age: 30};

    PersonK?[] personList = [p1, (), p2];

    PersonK[] outputPersonList =
                    from var person in personList
    where (person is PersonK)
    select {
        firstName: person.firstName,
        lastName: person.lastName,
        age: person.age
...
function testFromClauseWithStream() returns PersonK[] {
    PersonK p1 = {firstName: "Alex", lastName: "George", age: 30};
    PersonK p2 = {firstName: "Ranjan", lastName: "Fonseka", age: 40};
    PersonK p3 = {firstName: "John", lastName: "David", age: 50};

    PersonK[] personList = [p1, p2, p3];
    stream<PersonK> streamedPersons = personList.toStream();
...
function testFunctionCallInVarDeclLetClause() returns PersonK[] {
    ...
    var outputPersonList =
            from PersonK person in personList
...
function testUseOfLetInWhereClause() returns PersonK[] {

    PersonK p1 = {firstName: "Alex", lastName: "George", age: 18};
    PersonK p2 = {firstName: "Ranjan", lastName: "Fonseka", age: 22};
...
function testSimpleSelectQueryReturnStream() returns boolean {
    ...
    stream<PersonK> outputPersonStream = stream from var person in personList
        select {
            firstName: person.firstName,
            lastName: person.lastName,
            age: person.age
        };
    PersonK? returnedVal = getRecordValue(outputPersonStream.next());
    testPassed = testPassed && (returnedVal is PersonK) && (returnedVal == p1);

    returnedVal = getRecordValue(outputPersonStream.next());
    testPassed = testPassed && (returnedVal is PersonK) && (returnedVal == p2);

    returnedVal = getRecordValue(outputPersonStream.next());
    testPassed = testPassed && (returnedVal is PersonK) && (returnedVal == p3);
    return testPassed;
}
...
function testQueryExprWithLangLibCallsWithArrowFunctions() {
    PersonK p1 = {firstName: "Alex", lastName: "George", age: 30};
    PersonK p2 = {firstName: "Anne", lastName: "Frank", age: 40};
    PersonK p3 = {firstName: "John", lastName: "David", age: 50};
    PersonK[] personList = [p1, p2, p3];
    ...
    PersonK[][] filteredPersons = from int age in [50]
