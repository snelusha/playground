...
const testCases: TestCase[] = [
  {
    name: "hello world",
    files: async () => new Map([["/tmp/main.bal", await load("./fixtures/hello-world.bal")]]),
...

  {
    ...
    files: async () =>
      new Map([
        ["/tmp/hello-world/main.bal", await load("./fixtures/hello-world/main.bal")],
        ["/tmp/hello-world/Ballerina.toml", await load("./fixtures/hello-world/Ballerina.toml")],
      ]),
  ...
  },
  {
    ...
    files: async () => new Map([["/tmp/main.bal", await load("./fixtures/file-read-write.bal")]]),
    entryPoint: "/tmp/main.bal",
    expectedStdout: "true\ntrue\ntrue\ntrue\n<book><title>Clean Code</title></book>\ntrue\n",
  },
  {
    name: "os env",
    files: async () => new Map([["/tmp/main.bal", await load("./fixtures/os-env.bal")]]),
    entryPoint: "/tmp/main.bal",
    expectedStdout: "true\ntrue\ntrue\ntrue\ntrue\n",
  },
];
